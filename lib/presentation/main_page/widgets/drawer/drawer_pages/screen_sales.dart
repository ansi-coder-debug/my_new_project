                      ...
                      itemBuilder: (context, index) {
                        ...
                        return OutputCard(
                          ...
                          onView: () {
                            ...
                            debugPrint("Viewing ${saleInfo.name}");
                          },
                          onEdit: () {
                            debugPrint("Editing sale of ${saleInfo.name}");
                          },
                          onDelete: () {
                            debugPrint("Deleting sale of ${saleInfo.name}");
                          },
                        );
                      },
                    ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Payment: ${saleInfo.paymentStatus} (${saleInfo.modeOfPayment})",
                                ),
