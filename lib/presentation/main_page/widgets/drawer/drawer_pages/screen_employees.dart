...
class ScreenEmployees extends ConsumerStatefulWidget {
  const ScreenEmployees({super.key});

  @override
  ConsumerState<ScreenEmployees> createState() => _ScreenEmployeesState();
}

class _ScreenEmployeesState extends ConsumerState<ScreenEmployees> {
  @override
  void initState() {
    super.initState();
    // Initial fetch
  ...
  Future<void> _openAddEmployeeModal() async {
    ...
    // After closing the modal, refresh the employee list
