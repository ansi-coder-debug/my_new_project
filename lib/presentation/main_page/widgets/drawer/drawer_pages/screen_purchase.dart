...
import 'package:my_new_project/widgets/purchase/purchase_edit_screen.dart';
...
class ScreenPurchase extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    builder: (context) => AlertDialog(
      ...
      content: Text('Are you sure you want to delete purchase of ${purchase.name}?'),
      actions: [
